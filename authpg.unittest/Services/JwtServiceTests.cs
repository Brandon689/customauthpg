...
//        Assert.Equal(user.Id.ToString(), jwtToken.Claims.First(c => c.Type == CustomClaimTypes.UserId).Value);
//        Assert.Equal(user.Username, jwtToken.Claims.First(c => c.Type == CustomClaimTypes.Username).Value);
//        Assert.Equal(user.Email, jwtToken.Claims.First(c => c.Type == CustomClaimTypes.Email).Value);
//        Assert.Equal(user.Role, jwtToken.Claims.First(c => c.Type == CustomClaimTypes.Role).Value);
//    }
...
//        // Assert
//        Assert.NotNull(principal);
//        Assert.Equal(user.Id.ToString(), principal.FindFirst(CustomClaimTypes.UserId)?.Value);
//        Assert.Equal(user.Username, principal.FindFirst(CustomClaimTypes.Username)?.Value);
//        Assert.Equal(user.Email, principal.FindFirst(CustomClaimTypes.Email)?.Value);
//        Assert.Equal(user.Role, principal.FindFirst(CustomClaimTypes.Role)?.Value);
//    }
